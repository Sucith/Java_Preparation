...
public class Function {
	public static void main(String[] args) {
		...
		paraMethod(20,80);					// the value to be computed is put inside the function call in case of use of parames
		
		Scanner inp = new Scanner (System.in);	// User input in the 
